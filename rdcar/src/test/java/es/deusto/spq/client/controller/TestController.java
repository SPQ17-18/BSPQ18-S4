...
public class TestController {
	...
	public void buscarEmpleadoTest() {
		try{
			logger.info("Test - Buscar cliente");
			String c = "12395678B";
			controller.buscarEmpleado("rebeca");
	...
	public void buscarVehiculoTest() {
		try{
			logger.info("Test - Buscar cliente");
			String c = "12395678B";
			controller.buscarVehiculo("2525");
	...
	@Test 
	public void buscarAlquilerTest() {
		try{
			logger.info("Test - Buscar cliente");
			String c = "12395678B";
			controller.obtenerAlquiler("2E");
	...
	public void borrarAlquilerTest() {
		try {
			...
			assertEquals(true, controller.BorrarAlquiler("2E")); //no debería pasar
